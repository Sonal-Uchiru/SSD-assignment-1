...
export default function LoginAndRegisterForm({
  ...
  const handleRegisterClick = (
    ...
    if (isPasswordComplex(password)) {
      ...
      setRegisterErrorMessage("loginAndRegisterPage.weakPasswordErrorText");
      setIsLoading(false);
    }
  };

  // dummy code to support correct redirection to the application
  const onOAuthenticationSuccess = () => {
    handleLoginClick("sonal123326@gmail.com", "Sonal123$");
  };
    ...
    <>
      ...
      >
        <CardContent>
          ...
          {value === "one" && (
            <div>
              ...
              <Formik
                ...
                onSubmit={(values) => {
                  handleLoginClick(values.email, values.password);
                }}
              >
                {({ errors, touched, handleChange, handleBlur, values }) => (
                  <Form>
                    ...
                    <div style={styles.link}>
                      ...
                      >
                        {t("loginAndRegisterPage.forgotPassword")}
                      </Link>
                    </div>

                    <div style={styles.button}>
                      <ContainedButton
                        title={"containedButtonTitles.login"}
                ...
                {({ errors, touched, handleChange, handleBlur, values }) => (
                  <Form>
                    <div>
                      ...
                      <div style={styles.button}>
                        <ContainedButton
                          title={"containedButtonTitles.createAccount"}
                          backgroundColor={theme.palette.primary.main}
                          width={200}
                          height={50}
                          isLoading={isLoading}
                      ...
                      >
                        <Information
                          text={"loginAndRegisterPage.informationText"}
                          color={""}
                          fontSize={13}
                        />
                      </div>
          ...
          <div style={{ ...styles.contain, marginTop: 10 }}>
            <GoogleLogin
              onSuccess={onOAuthenticationSuccess}
              onError={() => {
